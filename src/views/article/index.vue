<template>
    <div class="article-container">
        <!-- 导航栏 -->
        <van-nav-bar class="page-nav-bar" left-arrow title="CDUT 头条" @click-left="$router.back()"></van-nav-bar>
        <!-- /导航栏 -->
        ...
        <div class="main-wrap">
            ...
            <div class="article-detail" v-else-if="article.title">
                ...
                <van-cell class="user-info" center :border="false">
                    ...
                    <FollowUser class="follow-btn" :userId="article.aut_id" v-model="article.is_followed"></FollowUser>
                    <!-- <van-button class="follow-btn" round size="small" v-if="article.is_followed"
                ...
                <div class="article-bottom">
                    ...
                    <LikeArticle class="btn-item" v-model="article.attitude" :articleId="article.art_id"></LikeArticle>
    ...
    methods: {
        async loadArticle() {
            ...
            try {
                ...
                console.log("-----loadArticle-----，获取数据失败", error)
            }
